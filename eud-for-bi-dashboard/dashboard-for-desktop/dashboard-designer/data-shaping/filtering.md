...
This invokes the [Filter Editor](../ui-elements/filter-editor/filter-data-via-the-filter-editor.md) dialog that allows you to build complex filter criteria:
 -->

![DataShaping_Filtering_FilterEditor](../../images/datashaping_filtering_filtereditor19370.png)

> [!Tip]
> **Documentation**: [Filter Editor](../ui-elements/filter-editor/filter-data-via-the-filter-editor.md) 
