...
5. On the next page, you can specify the filter used to extract data. To learn how to specify the filter criteria, see [Filter Data via the Filter Editor](../ui-elements/filter-editor/filter-data-via-the-filter-editor.md).
