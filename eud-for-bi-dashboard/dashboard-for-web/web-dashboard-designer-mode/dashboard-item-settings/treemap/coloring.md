...
If necessary, you can change default behavior. For example, the image below shows the Treemap dashboard item whose measures and argument values are painted with the same color.

![Web Dashboard - Treemap Colored by Same Color](../../../images/img125995.png)

To change default coloring behavior, go to the **Coloring** section of the Treemap's [Options](../../ui-elements/dashboard-item-menu.md) menu.

![Web Dashboard - Treemap Coloring Options](../../../images/img125996.png)

> [!NOTE]
> You can change the default palette used to color Treemap tiles. To do this, go to the **Color Scheme** section of the Treemap's **Options** menu.
>
