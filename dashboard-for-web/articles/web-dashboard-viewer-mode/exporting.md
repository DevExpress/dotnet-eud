...
To export the entire dashboard, click the ![Printing_ExportElementButtonWeb](../../images/Img19570.png) button in the [dashboard title](../../../dashboard-for-web/articles/web-dashboard-viewer-mode/data-presentation/dashboard-layout.md) area and select the required format.
...
To export a dashboard item, click the ![Printing_ExportElementButtonWeb](../../images/Img19570.png) button in its [caption](../../../dashboard-for-web/articles/web-dashboard-viewer-mode/data-presentation/dashboard-layout.md) and choose the required action.
