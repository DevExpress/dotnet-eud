...
To bind a dashboard parameter to an SQL query/stored procedure parameter in the [Dashboard Data Source Wizard](../../providing-data/dashboard-data-source-wizard.md), do the following:
