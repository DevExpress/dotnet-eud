---
title: Specify Data Source Settings (MongoDB)
---
# Specify Data Source Settings (MongoDB)

This page appears when you select **MongoDB** on the start page.

![Web Data Source Wizard - Specify Data Source Settings for MongoDB](../../../images/web-fullscreen-datasource-wizard-mongodb-datasource.png)

## Choose a Data Connection

Select a connection from the list: 

![Web Data Source Wizard - Select Connection for MongoDB](../../../images/web-wizard-mongodb-select-connection.png)

## Configure Queries

In the next section, configure queries. Click the plus sign to add a new query. Specify the database, collection, and alias.

![Web Data Source Wizard - Configure Queries](../../../images/web-wizard-mongodb-configure-queries.png)
...
![Web Data Source Wizard - Select Data Fields](../../../images/web-wizard-mongodb-select-data-fields.png)
