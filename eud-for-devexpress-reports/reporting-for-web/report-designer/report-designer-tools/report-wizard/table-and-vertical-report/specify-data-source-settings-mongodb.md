...
![Web Report Wizard - Select Connection for MongoDB](../../../../images/web-wizard-mongodb-select-connection.png)

## Configure Queries

In the next section, configure queries. Click the plus sign to add a new query. Specify the database, collection, and alias.

![Web Report Wizard - Configure Queries](../../../../images/web-wizard-mongodb-configure-queries.png)
...
![Web Report Wizard - Select Data Fields](../../../../images/web-wizard-mongodb-select-data-fields.png)
