...
1. [Add a JSON data source](../bind-to-data/bind-a-report-to-json-data.md) that uses the following JSON string:
...
1. The invoked [Query Builder](../report-designer-tools/query-builder.md) displays the columns that you can transform.
