...
![Report with watermarks applied](../../images/eurd-web-add-watermarks-result.png)
...
![Watermark properties panel](../../images/eurd-web-add-watermarks-properties-panel.png)
...
![Draw watermark property](../../images/eurd-web-add-preprinted-watermark.png)
...
![Template watermark at design time](../../images/eurd-web-add-a-template-watermark.png)

Place report controls on the report's body according to the layout of the preprinted form.

![Controls on template watermark](../../images/eurd-web-add-a-template-watermark-result.png)	
...
![Combined text and image watermark](../../images/eurd-web-watermark-text.png)
...
![Watermark Id property](../../images/web-eud-watermark-id-option.png)
...
![Conditional watermarks on pages](../../images/eurd-web-watermark-image.png)
