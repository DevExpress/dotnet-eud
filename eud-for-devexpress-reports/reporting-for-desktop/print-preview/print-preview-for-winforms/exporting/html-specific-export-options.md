...
* **Export Mode**
	...
	* The **Single file page-by-page** mode allows you to export a document to a single file, while preserving page-by-page breakdown. In this mode, the **Page range**, **Page border color** and **Page border width** options are available.
