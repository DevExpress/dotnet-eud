...
To open a previously saved document, click the **Open** ![Open button icon](../../../images/img7260.png) button on the toolbar, or press CTRL+O.

On the invoked **Open** dialog, define the file and click **Open**.

![Open dialog window](../../../images/img7377.png)
