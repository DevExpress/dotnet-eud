...
![Report Designer - Control Dimension Notations Visibility in UI](../../../images/vs-dimension-notation-ui.png)

The notation are based on a selected report unit:

| System of Measurement | Displayed Unit | Image |
| --- | --- | --- |
| Imperial system     | inches | ![Report Designer - Dimension Notations in inches](../../../images/vs-dimension-notation-imperial-unit.png)     |
| Metric system     | millimeters | ![Report Designer - Dimension Notations in millimeters](../../../images/vs-dimension-notation-metric-unit.png)     |
| Screen coordinates | pixels |![Report Designer - Dimension Notations in pixels](../../../images/vs-dimension-notation-pixels-unit.png) |