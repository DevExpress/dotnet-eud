...
![A date range parameter's editor in Preview](../../../images/use-date-ranges-parameters-panel.png)
...
![A date range parameter's editor on Print Preview.](../../../images/use-date-ranges-parameters-panel.png)

**An editor for "Time" range parameters:**

![A time range parameter's editor on Print Preview.](../../../images/use-time-ranges-parameters-panel.png)
...
![The report data is filtered by the date range](../../../images/use-date-ranges-parameters-filtered.png)
