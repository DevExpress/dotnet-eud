...
1. From the [Control Toolbox](../report-designer-tools/ui-panels/toolbox.md), drop the [Table of Contents](../use-report-elements/use-basic-report-controls/table-of-contents.md) control onto the [Report Header band](../introduction-to-banded-reports.md).
