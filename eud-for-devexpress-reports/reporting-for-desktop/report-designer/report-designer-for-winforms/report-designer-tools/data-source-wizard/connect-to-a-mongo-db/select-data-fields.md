...
![Select Data Fields](../../../images/data-source-wizard-select-data-fields.png)

Use the drop-down menu to select a collection whose data fields you want to configure.

![Specify collection](../../../images/data-source-wizard-select-a-collection.png)

Enable or disable a checkbox in the Field Name column to include or remove a field from a collection.

![Manage fields](../../../images/data-source-wizard-manage-fields.png)
