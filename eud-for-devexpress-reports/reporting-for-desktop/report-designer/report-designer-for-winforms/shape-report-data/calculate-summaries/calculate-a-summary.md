...
1. Use the [Group and Sort Panel](../../report-designer-tools/ui-panels/group-and-sort-panel.md) to [group report data](../group-and-sort-data/group-data.md) by the key data field and construct a layout like the following:
