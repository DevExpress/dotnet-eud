...
2. Drop the [Page Info](../use-report-elements/use-basic-report-controls/page-info.md) control from the [Toolbox](../report-designer-tools/ui-panels/toolbox.md) onto the **ReportHeader** band.
