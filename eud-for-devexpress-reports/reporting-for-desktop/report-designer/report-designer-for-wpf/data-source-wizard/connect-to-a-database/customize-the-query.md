...
1. Select the **Query** option and click the **Run Query Builder** button.
	...
	![Run Query Builder button](../../../../images/img122116.png)
...
![Select stored procedure](../../../../images/img122124.png)
...
Otherwise, clicking **Next** will open the next Report Wizard page: [Choose Columns to Display in a Report](../../report-wizard/data-bound-report/choose-columns-to-display-in-a-report.md).