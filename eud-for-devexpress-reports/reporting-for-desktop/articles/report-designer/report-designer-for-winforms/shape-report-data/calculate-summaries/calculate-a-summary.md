...
1. In the **Summary Editor** form, use the following options:
	...
	* **Argument expression** - specifies a data field or a complex expression.
	...
	<!-- See the <!-- [Expression Operators, Functions and Constants](~/interface-elements-for-desktop/articles/expression-editor/expression-operators-functions-and-constants.md) - Link disabled: interface-elements not included  topic for a complete list of supported summary functions. --> 
