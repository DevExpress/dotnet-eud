...
![](~/reporting-for-desktop/images/eurd-win-add-table-to-multiple-bands.png)
...
![](~/reporting-for-desktop/images/eurd-win-table-structure-in-report-explorer.png)
...
![eurd-win-table-cell-line-spacing](~/reporting-for-desktop/images/eurd-win-table-cell-line-spacing.png)
...
![](~/reporting-for-desktop/images/eurd-win-drop-check-box-onto-table-cell.png)
...
![](~/reporting-for-desktop/images/eurd-win-fit-bounds-to-container.png)
...
![](~/reporting-for-desktop/images/eurd-win-table-convert-to-labels.png)
