...
![](~/eud-for-devexpress-reports/reporting-for-desktop/images/eurd-win-drop-table-from-toolbox.png)
...
![](~/eud-for-devexpress-reports/reporting-for-desktop/images/eurd-win-add-table-to-multiple-bands.png)
...
![](~/eud-for-devexpress-reports/reporting-for-desktop/images/eurd-win-table-structure-in-report-explorer.png)

You can double-click the cell to invoke its in-place editor and type the desired static text.

![](~/eud-for-devexpress-reports/reporting-for-desktop/images/eurd-win-table-cell-static-text.png)
...
![](~/eud-for-devexpress-reports/reporting-for-desktop/images/eurd-win-table-cell-fit-text-to-bounds.png)
...
![eurd-win-table-cell-line-spacing](~/eud-for-devexpress-reports/reporting-for-desktop/images/eurd-win-table-cell-line-spacing.png)
...
![](~/eud-for-devexpress-reports/reporting-for-desktop/images/eurd-win-drop-check-box-onto-table-cell.png)
...
![](~/eud-for-devexpress-reports/reporting-for-desktop/images/eurd-win-fit-bounds-to-container.png)
...
![](~/eud-for-devexpress-reports/reporting-for-desktop/images/eurd-win-table-convert-to-labels.png)
