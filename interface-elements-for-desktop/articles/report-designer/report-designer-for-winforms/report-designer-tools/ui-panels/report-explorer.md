...
You can use the **Report Explorer** to switch to a report element. Right-click the element in the **Report Explorer** and select **Navigate To Control** from the drop-down menu.
