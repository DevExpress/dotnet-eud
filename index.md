...
You can download the source code and use it as white-label documentation in accordance with our [DevExpress End-User Documentation License Agreement](https://github.com/DevExpress/dotnet-eud/blob/master/LICENSE.md).

View the source code at: [github.com/DevExpress/dotnet-eud](https://github.com/DevExpress/dotnet-eud).
