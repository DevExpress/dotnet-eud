...
| Total(SummaryExpression) | Returns the total for the specified expression in a calculation window. Note that the **Total** function calculates the total based on values from the [underlying data source](../../../../../dashboard-for-desktop/articles/dashboard-designer/providing-data.md). | Total(Sum([Sales])) | ![CalculationFunction_Total](../../../../images/Img123030.png) |

> Note that window functions cannot be used inside **[Aggr](../../../../../dashboard-for-desktop/articles/dashboard-designer/data-analysis/aggregations/intermediate-level-aggregations.md)**.