...
... or use a corresponding button within the [Query Builder](using-the-query-builder.md).
<!-- This will invoke the [Filter Editor](~/interface-elements-for-desktop/articles/filter-editor/filter-data-via-the-filter-editor.md) dialog, which --> This allows you to build filter criteria.
