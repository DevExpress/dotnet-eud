...
Specify the required options in this dialog and click the **Export** button to export the Scatter Chart dashboard item. To reset changes to the default values, click the **Reset** button.
